    ...
    <>
      {!showProduct ? (
        ...
        <button
          ...
          className="group relative hover:text-shop_light_yellow hoverEffect border border-shop_light_yellow/80 hover:border-shop_light_yellow p-1.5 rounded-sm"
        >
          {existingProduct ? (
            <Heart
              fill="#3b9c3c"
            ...
            <Heart className="text-shop_light_yellow/80 group-hover:text-shop_light_yellow hoverEffect mt-.5 w-5 h-5" />
          )}
        </button>
      )}
    </>
